# Session 2 — The Living Conduit

**Level 5 · ~3 hours · RP / Puzzle / Revelation / Tension**

*"When you know someone will die for a cause — do you tell them before they choose, or after?"*
...
**Central Question:** Do you have the right to decide someone else's fate, even to save thousands?

**Session Arc:** Care → Understand → Shatter → Choose

| NPC | Want | Fear | Lie |
|-----|------|------|-----|
| **Sera Voss** | To be useful while she still can | That she's already past the threshold of return | "I'm not afraid of what the ritual means" |
| **Theron Waide** | Absolution | That telling the truth will destroy the thing it's trying to save | "I found out recently" |
| **Harran Lecht** | The ritual stopped — by any means | That the Dawnborn have already chosen | "We only want to talk" |

**Handouts this session:**
- Fragment II (Scene 2) — brass puzzle cylinder, Dawnmark star map
...
*(Passive Perception ≥ 13: The streets thin out faster than normal for this hour. People glance up at the amber sky and move inside. This happens every evening in Varenhold — a reflex fifty years old.)*

</details>

<details>
<summary>📄 The Truth — What This Session Reveals</summary>

**The revelation:** The Dawn Ritual does not use energy drawn from ley lines, Spire capacitors, or stored ambient magic. It uses *people*. Specifically: the Dawnborn — survivors of the original Silence — whose bodies adapted to fill the gap the sun left. The ritual reactivates the sun by draining that adaptation permanently. Every Dawnborn who survives the ritual is left as an ordinary person in a world that no longer has the disease they were immune to. Every Dawnborn who doesn't survive the ritual is ash.

**The escalation of stakes:**

| Scale | Stakes |
|-------|--------|
| Personal | Sera Voss — warm, alive, specific — will probably die in the ritual |
| Local | All 14 known Dawnborn in Varenhold face the same choice |
| Faction | The Reckoning wants to force the ritual regardless of Dawnborn consent |
| Cosmic | Without the ritual, the grey sickness kills 60% of Varenhold within four years |

**Pre-session secrets (ask each player privately before starting):**

- *One player:* "Your character has noticed Sera in the Dawnhall before. They don't know her name. What did they notice about her?"
- *One player:* "Your character has a family member who died of grey sickness. How recent is that loss?"
- *One player:* "Your character read something in the Archive about the Silence — what single detail stuck with them?"

These are seeds. They don't change the plot. They make the revelation personal.
...
**If players stall in Scene 2** (puzzle takes too long): Sera can offer to "show them a trick her father taught her" — she's seen the box before. She sets two cylinders; players solve the remaining three. She doesn't know what it opens or why it matters.

**If players try to skip to Theron after Scene 3** (bypass Scene 4): Theron finds *them*. He's been watching the Archive for anyone who touched the box. His confession scene works in any location.
...
Sera Voss manages the Dawnhall's emergency feeding programme. She has been doing this for nine years. She is not dramatic about it. She does not want credit. She wants the numbers to add up.
...
<details>
<summary>📄 Exit — Theron's Message</summary>

A Dawnhall worker comes in with a folded note. Sera reads it, folds it again, and passes it to the nearest player without comment.
...
**She accompanies the party to Scene 2 unless actively refused.**
...
<details>
<summary>📁 Scene 3 — The Decoding (Revelation)</summary>
...
| | |
|---|---|
| **Goal** | Players decode the cipher; the ritual's true mechanism becomes clear |
| **Location** | Sera's table at the Dawnhall, or wherever is private |
...
> The combined cylinders, when rotated slowly, produce a sequence of symbols that correspond to the oldest known Varenhold writing system. The message is partial — some symbols worn past reading — but the core is clear.
>
> *"...the conduit is not stone or silver or stored potential. The conduit is awareness sustained against the dark. The Dawnborn are not witnesses to the Silence. They are its answer. Their adaptation is the bridge. The ritual completes what was interrupted — it draws through what learned to hold the gap. Each anchor gives what they became."*

**Translation for players who ask:** The ritual runs *through* the Dawnborn. Their post-Silence adaptation is the mechanism. They are not observers. They are components.

**Theron walks in as they finish the last line.**

*(Passive Perception ≥ 14: He's been waiting outside. He heard the box open from the street.)*
...
<details>
<summary>📁 Scene 4 — Theron's Confession (Gut-Punch)</summary>
...
| | |
|---|---|
| **Goal** | The emotional centre of the session. Players leave this scene changed. |
| **Location** | Wherever they are — this scene works in any room |
...
<details>
<summary>📄 DM Direction — Hold the Silence</summary>

After "Eleven years," **stop talking**.

Wait for a player to speak. Do not prompt. Do not fill the space. This is the emotional beat the entire session has been building toward. If the room is quiet for thirty seconds, that thirty seconds is doing its job.

When players respond, Theron listens fully before answering anything. He is not defending himself. He has had eleven years to construct defences and he has decided not to use them.

</details>

<details>
<summary>📄 What Theron Will and Won't Say</summary>

**He will say, without prompting:**
- He does not know how many Dawnborn survive versus die in the ritual. The documentation suggests "most" do not. He does not know what "most" means in numbers.
- He gave Sera the box because he trusted her and because he could not destroy it.
- He has been monitoring the Reckoning's research for six years. They are close to an independent derivation. "Three months. Perhaps less."
- "I have been waiting for someone with enough courage — or ignorance — to investigate seriously. I did not know what I would say when they arrived. I still don't."

**He will not say without a check:**
- *(Insight DC 15)* He contacted Harran Lecht two years ago to test whether the Reckoning could be reasoned with. They could not. He has not told anyone this.
- *(Persuasion DC 16)* He has a second copy of the ritual documentation. It is not in the Archive.
- *(Intimidation DC 17)* He briefly considered destroying the Archive collection and removing himself from the situation. He couldn't do it. "The truth doesn't stop being true."

**Character-Specific Moments:**

| Character | What lands differently |
|-----------|----------------------|
| **Cleric / Paladin** | *(Auto)* Theron is not asking for absolution but he is shaped like someone who wants it. The question of whether eleven years of anguish earns anything is a theological problem with no clean answer. |
| **Rogue / Criminal background** | Eleven years of sitting on information that could reshape a city. The question isn't moral — it's strategic. He's been playing a very slow game. |
| **Fighter / Any direct archetype** | "You had the answer and you sat on it for eleven years while people died of grey sickness." This is a legitimate accusation. Theron will not argue with it. "Yes." |
| **Wizard / Sage background** | *(History DC 12)* The three-year attempt at an alternative mechanism isn't mentioned in any Archive publications. He did that research in private. Whatever he tried, he destroyed the record of trying. |

</details>

<details>
<summary>📄 Sera</summary>

Sera has been silent since Theron sat down. After Theron finishes, players may or may not notice her.

*(Passive Insight ≥ 11: She's not shocked. She worked this out somewhere in the middle of the decoding. She's been deciding what to do with knowing.)*

If players ask her what she's thinking:

> "I'm thinking I'm going to need to talk to the others." A breath. "I'm thinking eleven years is a long time to carry something alone." She looks at Theron. Not with anger. With something harder to name. "I'm also thinking you should have told me."
>
> She stands. "I'll make tea. None of us are going anywhere for a while."

**DM Direction:** Sera making tea is the scene exhaling. Let players have a conversation — with each other, with Theron, with Sera — before the knock at the door.
...
<details>
<summary>📄 Consequences Tracker</summary>

Fill this out at the end of session. Carry it to Session 3.
...
<details>
<summary>📄 Debrief Question</summary>
...
<details>
<summary>📁 Random Encounters (Varenhold — Lowmark District)</summary>

<details>
<summary>📄 d6 Table</summary>

Roll if players spend significant time in the streets or if pacing stalls.

| d6 | Encounter |
|----|-----------|
| 1 | Grey sickness response team moving a body. Two tired healers, a cart, a covered shape. They don't stop. Nobody stops them. |
| 2 | A Reckoning pamphlet distributor — young, earnest, not Harran's people. The pamphlet promises "restoration within the year." No details. |
| 3 | A Dawnborn child (one of three known, under 12) chasing a ball into the street. She stops when she sees the players. She has the same faint luminescence as Sera. She's old enough to know what it means and young enough to hate that she knows. |
| 4 | A food queue at the Dawnhall side door. Longer than it should be at this hour. A worker is apologising to people at the end — the supply came up short. Again. |
| 5 | An amber lamp on a corner post burns brighter than the others for a moment, then dims. Some people nearby look up hopefully. Old reflex. The sky doesn't change. |
| 6 | Aldric, the Dawnhall's senior door-warden (Fighter 3, friendly), intercepts players on their way to Sera. "She expecting you? Because she's had a strange week and she doesn't need strangers adding to it." Roleplaying past him takes DC 12 Persuasion or a name he recognises (Theron's). |
