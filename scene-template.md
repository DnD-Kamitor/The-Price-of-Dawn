...
*Fill this last. It is the compressed version of everything below. A GM who has prepped this session should be able to run from this card alone.*
...
*2–3 sentences. Facts about the situation players are walking into. What exists in the fiction right now, stated flatly. This is the frame; the read-aloud is the picture.*

**Why players are here**

*The causal chain that brought this party to this specific moment. The mechanical and narrative reason they are standing in this location right now.*
...
*How this scene connects to the campaign's central questions and what it sets up later. Name the scene or session where this pays off. "Establishes X, which becomes the pressure point in Scene 5." This prevents scenes from feeling like filler.*
...
- **First impression (read-aloud line):** *1–2 sentences, second person, present tense*
...
- **What it is physically:** *Material, condition, size, how sealed or stored*
- **Trigger moment:** *Exact in-scene event*
- **Handoff narration:** *One sentence, in scene tone*
- **What it reveals without checks:** *Plain information*
- **What a skill check adds:** *DC [N] [Skill]: [additional reveal]*
- **How it connects forward:** *Future scene or revelation*
...
*Dimensions, exits, cover positions, landmarks. Write enough that you can describe the space at the table without referencing a map. Include: approximate size, what's at each compass point or in each zone, significant objects and where they sit, lighting and visibility. An ASCII sketch is acceptable and often faster.*

**Interactive Objects**

*List every object a player might touch, pick up, open, search, climb, move, or destroy. If you haven't thought through what happens when they interact with it, you'll fumble it at the table. One line each.*
...
*Every skill check result should be specific and useful. "You notice the room is old" is not a result. "Investigation DC 13: the eastern bookshelf has fresh drag marks in the dust and the wall behind it is a slightly different shade of stone" is a result.*
...
*The living dungeon principle. NPCs are not waiting in their rooms. They are doing something, they know things, specific events change their behavior, and if players never find them they still go somewhere.*
...
**[NPC Name]**
- **Right now:** *Exact physical action*
- **Knows:** *Information state*
- **Triggered by:** *Named specific trigger*
...
*Name the specific future scene, NPC, or object. Not "they'll figure it out." "If they skip this scene, [NPC] names the same fact directly in Scene [N] if asked [specific question]."*

**What is genuinely lost:**
*Be honest. Some things do not recover. A missed prop cannot be handed out later. A missed NPC interaction leaves a gap in the relationship. Name what's actually gone versus what players can still get elsewhere.*
...
>
> **[Attack name].** *Melee/Ranged Weapon Attack:* +[N] to hit, reach [N] ft / range [N/N] ft, one target. *Hit:* [N] ([NdN+N]) [damage type] damage.
>
...
MECHANICS
□ Key DCs memorized: [list them here]
□ Encounter stat block tabbed: [enemy name]
