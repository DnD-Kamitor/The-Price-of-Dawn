...
```
╔══════════════════════════════════════════════════════════════════╗
║  REF: VLT-002     VAULT — FLOOR PLAN (TOP VIEW)   SCALE: 1:50   ║
...
Date          Entry                              Auth.
──────────────────────────────────────────────────────
[early year]  Candle stock replenished, 200ct    B.H.
...
```
WKUHH QLJKWV. LI QR ZRUG EB GDZQ — DQG WKHUH
LV QR GDZQ — SXOO EDFN. WKH VHTXHQFH LV
...
*If you are grieving someone the grey sickness took: we see you.*
*If you want to help: find us. We are not hard to find.*
